...
**Current activity:** Rosa reports improved B1 transitions and approved the B2 character examples. B2 context-aware wording, voice delivery, and local reactions are implemented for both demo and real care; integrated listening/expression acceptance is next. See [B2 delivery and manual checks](./TomoCare_Character_B2_Manual_Checks.md). No provider change is included.
